...
local function checkCodeIntegrity()
    if getfenv ~= protected.getfenv or
       setfenv ~= protected.setfenv or
       loadstring ~= protected.loadstring or
       pcall ~= protected.pcall or
       xpcall ~= protected.xpcall or
       newproxy ~= protected.newproxy or
       getmetatable ~= protected.getmetatable or
       setmetatable ~= protected.setmetatable or
       rawget ~= protected.rawget or
       rawset ~= protected.rawset or
       debug ~= protected.debug or
       string.byte ~= protected.string.byte or
       string.char ~= protected.string.char or
       string.format ~= protected.string.format then
        return false
    end
    return true
end
